 ...
 *   - retain: reter mensagem (0 para não reter, 1 para reter)
 *  */
void mqtt_comm_publish(const char *topic, const uint8_t *data, size_t len, const uint8_t retain) {
